#ifndef _ROS_ieu_agv_robot_location_h
#define _ROS_ieu_agv_robot_location_h
...
namespace ieu_agv
{
  ...
  class robot_location : public ros::Msg
  {
    public:
    ...
    const char * getType(){ return "ieu_agv/robot_location"; };
